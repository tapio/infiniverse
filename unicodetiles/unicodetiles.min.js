...
ut.Engine.prototype.update=function(a,b){var c=(a||0)-this.viewport.cx,d=(b||0)-this.viewport.cy,h=(new Date).getTime(),k;this.transition&&(k=(h-this.transitionTimer)/this.transitionDuration);1<=k&&(this.transition=void 0);for(var e,j=0;j<this.viewport.h;++j)for(var f=0;f<this.viewport.w;++f){var g=f+c,l=j+d;if(this.w&&(0>g||g>=this.w))e=ut.NULLTILE;else if(this.h&&(0>l||l>=this.w))e=ut.NULLTILE;else if(this.maskFunc&&!this.maskFunc(g,l))e=ut.NULLTILE;else if(this.transition&&!this.refreshCache)e=
this.transition(f,j,this.viewport.w,this.viewport.h,this.tileFunc(g,l),this.tileCache[j][f],k);else if(this.cacheEnabled&&!this.refreshCache){e=g-this.cachex;var m=l-this.cachey;0<=e&&e<this.viewport.w&&0<=m&&m<this.viewport.h?(e=this.tileCache[m][e],e===ut.NULLTILE&&(e=this.tileFunc(g,l))):e=this.tileFunc(g,l)}else e=this.tileFunc(g,l);this.tileCache2[j][f]=e;this.shaderFunc&&e!==ut.NULLTILE&&(e=this.shaderFunc(e,g,l,h));this.viewport.unsafePut(e,f,j)}this.cachex=c;this.cachey=d;c=this.tileCache;
...
ut.CanvasRenderer.prototype.render=function(){var a,b,c,d,h,k=this.view,e=this.view.buffer,j=k.w,f=k.h,g=0.5*this.th,l=0.5*this.gap;this.ctx.fillStyle=k.defaultBackground;this.ctx.fillRect(0,0,this.canvas.width,this.canvas.height);h=g;for(var m=0;m<f;++m){for(var n=d=0;n<j;++n)a=e[m][n],b=a.ch,c=a.getColorRGB(),a=a.getBackgroundRGB(),a.length&&a!==k.defaultBackground&&(this.ctx.fillStyle=a,this.ctx.fillRect(d,h-g,this.tw,this.th)),b.length&&(c.length||(c=k.defaultColor),this.ctx.fillStyle=c,this.ctx.fillText(b,
d+l,h)),d+=this.tw;h+=this.th}this.ctx2.drawImage(this.offscreen,0,0)};ut.DOMRenderer=function(a){this.view=a;this.spans=Array(a.h);this.colors=Array(a.h);for(var b=0;b<a.h;++b){this.spans[b]=Array(a.w);this.colors[b]=Array(a.w);for(var c=0;c<a.w;++c)this.spans[b][c]=document.createElement("div"),a.elem.appendChild(this.spans[b][c]);this.spans[b].push(document.createElement("br"));a.elem.appendChild(this.spans[b][a.w])}ut.viewportStyleUpdaterHack=this;setTimeout(function(){ut.viewportStyleUpdaterHack.updateStyle()},0)};
...
hint:d.DYNAMIC_DRAW},charIndex:{buffer:null,data:null,itemSize:1,location:null,hint:d.DYNAMIC_DRAW}};this.initBuffers=function(){var a,c,f=this.attribs,g=this.view.w,h=this.view.h;for(a in this.attribs)c=f[a],c.data=new Float32Array(6*c.itemSize*g*h);for(c=0;c<h;++c)for(var k=0;k<g;++k){var n=6*f.position.itemSize*(c*g+k);b(f.position.data,n,k*this.tw,c*this.th,this.tw,this.th);b(f.texCoord.data,n,0,0,1,1)}for(a in this.attribs)c=f[a],c.buffer&&d.deleteBuffer(c.buffer),c.buffer=d.createBuffer(),d.bindBuffer(d.ARRAY_BUFFER,
...
this.ctx.fillStyle="#000000";this.ctx.fillRect(0,0,this.offscreen.width,this.offscreen.height);this.ctx.fillStyle="#ffffff";for(var e=this.tw+this.pad,j=this.th+this.pad,f=0.5*j,g=0;g<c;++g){for(var l=0.5*this.pad,m=0;m<b;++m,++d){h=this.charArray[d];if(void 0===h)break;this.ctx.fillText(h,l+k,f);l+=e}if(!h)break;f+=j}a.texImage2D(a.TEXTURE_2D,0,a.RGBA,a.RGBA,a.UNSIGNED_BYTE,this.offscreen)};
...
ut.WebGLRenderer.prototype.render=function(){var a=this.gl;a.clear(a.COLOR_BUFFER_BIT);for(var b=this.attribs,c=this.view.w,d=this.view.h,h=this.view.buffer,k=!1,e=0;e<d;++e)for(var j=0;j<c;++j){var f=h[e][j],g=this.charMap[f.ch];void 0===g&&(this.cacheChars(f.ch,!1),k=!0,g=this.charMap[f.ch]);for(var l=6*b.color.itemSize*(e*c+j),m=6*b.charIndex.itemSize*(e*c+j),n=void 0===f.r?this.defaultColors.r:f.r/255,r=void 0===f.g?this.defaultColors.g:f.g/255,s=void 0===f.b?this.defaultColors.b:f.b/255,t=void 0===
f.br?this.defaultColors.br:f.br/255,u=void 0===f.bg?this.defaultColors.bg:f.bg/255,f=void 0===f.bb?this.defaultColors.bb:f.bb/255,q=0;6>q;++q){var p=l+q*b.color.itemSize;b.color.data[p+0]=n;b.color.data[p+1]=r;b.color.data[p+2]=s;b.bgColor.data[p+0]=t;b.bgColor.data[p+1]=u;b.bgColor.data[p+2]=f;b.charIndex.data[m+q]=g}}k&&this.buildTexture();a.bindBuffer(a.ARRAY_BUFFER,b.color.buffer);a.bufferData(a.ARRAY_BUFFER,b.color.data,b.color.hint);a.bindBuffer(a.ARRAY_BUFFER,b.bgColor.buffer);a.bufferData(a.ARRAY_BUFFER,
